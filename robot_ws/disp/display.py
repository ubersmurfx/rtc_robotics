...
class Display():
	def __init__(self, debug=False):
		...
		self._exit = False
		self.font = ImageFont.truetype('/home/RTC-C-2.0-005/rtc_robotics/robot_ws/disp/PixelOperator.ttf', 16)
	...
	def show_image(self):
		self.draw.rectangle((0, 0, self.oled.width, self.oled.height), outline=0, fill=0)
		self.image = Image.open("/home/RTC-C-2.0-005/rtc_robotics/robot_ws/disp/rtc_logo.png").convert('1')
